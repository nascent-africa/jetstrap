    ...
    <div class="col-12">
        <div class="d-flex justify-content-end">
            @if (Route::has('login'))
                <div class="">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="small text-muted">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="small text-muted">Login</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 small text-muted">Register</a>
                        @endif
                    @endif
                </div>
            @endif
                        ...
                        <div class="card-body border-right border-bottom p-3 h-100">
                            <div class="d-flex flex-row bd-highlight mb-3">
                                ...
                                <div class="pl-3 text-muted">
                                    <div class="mb-2">
                                        <a href="https://laravel.com/docs" class="text-muted font-weight-bolder">Documentation</a>
                                    </div>
                                    <p class="small">
                        ...
                        <div class="card-body border-bottom p-3 h-100">
                            <div class="d-flex flex-row bd-highlight mb-3">
                                ...
                                <div class="pl-3 text-muted text-sm">
                                    <div class="mb-2">
                                        <a href="https://laracasts.com" class="text-muted font-weight-bolder">Laracasts</a>
                                    </div>
                                    <p class="small">
                    ...
                    <div class="col-md-6">
                        <div class="card-body border-right p-3 h-100">
                            <div class="d-flex flex-row bd-highlight mb-3">
                                ...
                                <div class="pl-3 text-muted text-sm">
                                    <div class="mb-2">
                                        <a href="https://laravel-news.com/" class="text-muted font-weight-bolder">Laravel News</a>
                                    </div>
                                    <p class="small">
                    ...
                    <div class="col-md-6">
                        <div class="card-body p-3 h-100">
                            <div class="d-flex flex-row bd-highlight mb-3">
                                ...
                                <div class="pl-3 text-muted text-sm">
                                    <div class="mb-2">
                                        <span class="text-muted font-weight-bolder text-decoration-underline">Vibrant Ecosystem</span>
                                    </div>
                                    <p class="small">
