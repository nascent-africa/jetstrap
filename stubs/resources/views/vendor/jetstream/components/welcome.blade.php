    ...
    <div class="col-md-12">
        <div class="card shadow bg-light">
            <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
                ...
                <div class="mt-5 font-weight-bold h-25">
                    ...
                    <div class="card-body border-right border-bottom p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3 text-muted">
                                <div class="mb-2">
                                    <a href="https://laravel.com/docs" class="text-muted font-weight-bolder text-decoration-none">Documentation</a>
                                </div>
                                <p>
                                    Laravel has wonderful documentation covering every aspect of the framework. Whether you're new to the framework or have previous experience, we recommend reading all of the documentation from beginning to end.
                                </p>
                                <a href="https://laravel.com/docs" class="text-decoration-none">
                                    <div class="mt-3 d-flex align-content-center small font-weight-bold text-primary">
                ...
                <div class="col-md-6">
                    <div class="card-body border-bottom p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3 text-muted text-sm">
                                <div class="mb-2">
                                    <a href="https://laracasts.com" class="text-muted font-weight-bolder text-decoration-none">Laracasts</a>
                                </div>
                                <p>
                ...
                <div class="col-md-6">
                    <div class="card-body border-right p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3 text-muted text-sm">
                                <div class="mb-2">
                                    <a href="https://tailwindcss.com/" class="text-muted font-weight-bolder text-decoration-none">Tailwind</a>
                                </div>
                                <p>
                ...
                <div class="col-md-6">
                    <div class="card-body p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3 text-muted text-sm">
                                <div class="mb-2">
                                    <span class="text-muted font-weight-bolder text-decoration-underline text-decoration-none">Authentication</span>
                                </div>
                                <p>
